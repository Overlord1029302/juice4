...
@onready var detection_area = $DetectionArea  # Reference to the detection Area2D
...
var player_in_area = false  # Tracks if player is inside detection zone

@onready var damage_timer = $AttackTimer
